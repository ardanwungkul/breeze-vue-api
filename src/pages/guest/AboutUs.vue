        ...
        <div
            ...
            <div class="min-h-full w-full flex">
                ...
                <div class="w-full h-screen flex flex-col md:flex-row">
                    <div
                        class="w-full h-full md:w-[66.66vw] md:min-h-[95vh] flex items-center">
                        <div
                            v-for="i in about"
                            :key="i.index"
                            :class="{
                                block: activeDiv === i.index,
                                hidden: activeDiv !== i.index,
                            }"
                            class="w-full px-4 md:px-24 flex flex-row items-center">
                            <div class="w-3/5">
                                <div class="text-2xl md:text-3xl pb-2 md:pb-5">
                                    {{ i.title }}
                                </div>
                            ...
                            <div
                                class="w-2/5 min-h-full flex items-center md:min-h-[40vh] relative">
                                <img
                                    class="max-h-full"
                                    :src="i.img"
                                    alt=""
                                ...
                                <div
                                    style="
                                        box-shadow: 0px -200px 100px rgb(
                                                248,
                                                248,
                                                246
                                            ) inset;
