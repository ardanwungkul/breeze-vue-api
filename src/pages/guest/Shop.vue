                    ...
                    <div class="w-full md:w-3/4 flex flex-col">
                        ...
                        <div>
                            <div
                                ...
                                <div
                                    class="flex flex-col rounded-xl w-full shadow-lg shadow-black/15 relative"
                                        ...
                                        <div class="relative">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="w-[100px] h-[100px] text-white text-sm p-0 -mx-1 -mt-1 -mb-[10px] rounded leading-5 flex items-center justify-center relative overflow-hidden">
                                                        <i
                                                            class="template-span-before bg-[#fd70ff] border-[#fd70ff]"></i>
                                                        <i
                                                            class="template-i bg-transparent block absolute z-2 border-b-4 border-l-4 border-l-transparent filter brightness-50 left-[34px] top-0 w-[11px]"></i>
                                                        <i
                                                            class="template-i-before bg-[#fd70ff] border-[#fd70ff] bg-gradient-to-r from-[#ff69fa] to-[#9881f7] block absolute h-[22px] w-[130px] left-[12px] top-[12px] text-center transform -moz-transform -ms-transform -webkit-transform rotate-45 -o-transform z-[3]"></i>
                                                        <i
                                                            class="template-i-after bg-transparent block absolute h-[11px] w-0 border-b-4 border-l-4 border-b-transparent filter brightness-50 bottom-[34px] right-0 z-[2]"></i>
                                                        <b
                                                            :class="
                                                                item.product_tags &&
                                                                item.product_tags ===
                                                                    ...
                                                                    : 'text-sm'
                                                            "
                                                            class="text-center z-[3] bg-transparent block left-[12px] leading-[22px] h-[22px] absolute top-[12px] transform rotate-45 -moz-transform -ms-transform -webkit-transform -o-transform w-[130px]">
                                                            {{
                                                                item.product_tags ===
                                                                'new'
                                                                    ? 'NEW'
