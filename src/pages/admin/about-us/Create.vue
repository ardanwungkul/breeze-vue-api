...
const addAboutUs = async newAboutUs => {
    await storeAboutUs.addAboutUs(newAboutUs, setErrors, processing)
}
...
const handleAdd = async () => {
    ...
    await addAboutUs(formData, processing)

    about_us_title.value = ''
    about_us_description.value = ''
    about_us_main_image.value = ''
    about_us_second_image.value = ''
    about_us_main_image_alt.value = ''
    about_us_second_image_alt.value = ''
    ...
    // router.push({ name: 'admin.about-us.index' })
}
...
<template>
    <AdminLayout title="Add About Us">
        ...
        <div class="w-full">
            <div class="w-full mx-auto bg-light-primary-1 dark:bg-dark-primary-2 dark:text-white rounded-lg shadow-lg duration-500">
                <div class="flex justify-between border-b py-3 px-4 items-center">
