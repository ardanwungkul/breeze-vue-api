                ...
                <form @submit.prevent="editProduct" enctype="multipart/form-data">
                    <div class="space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-3 col-span-2">
                                    <div class="flex flex-col gap-2 text-sm">
                                        ...
                                        <input
                                            ...
                                            id="product_promo_price" placeholder="Enter Promo Price Value" />
                                    </div>
                                    <div class="flex flex-col gap-2 text-sm">
                                        <div class="flex justify-between items-center">
                                            <label class="dark:text-light-primary-1"
                                                for="product_promo_percentage">Promo Percentage Value</label>
                                        </div>
                                        <input
                                            class="text-sm rounded-lg bg-light-primary-1 w-full dark:bg-dark-primary-1 dark:text-light-primary-1 border !border-gray-500 dark:!border-typography-3"
                            ...
                            <div class="my-5">
                                ...
                                <div class="px-3">
                                    <label for="image3D"
                                        ...
                                        <img :src="img3D" class="w-32 h-32 object-cover" v-if="img3D" alt="" />
                        ...
                        <div
                            ...
                            <div class="flex flex-wrap gap-3 px-3" v-if="
                                bundlings.length > 0 ||
                                            ...
                                            <div class="px-3 py-2">
                                                <div class="flex flex-col gap-3 justify-center items-center">
                                                    <div class="flex self-end">
                                                        <ConfirmDelete :label="'Delete'" :type="'Product Bundle'"
                                                            :id="item.id" :method="deleteVariant
                                                                "></ConfirmDelete>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <multiselect v-model="item.product" :options="allProduct"
                                        ...
                                        <div v-for="(
                                            ...
                                            <div class="px-3 py-2">
                                                <div class="flex flex-col gap-3 justify-center items-center">
                                                    ...
                                                    <input placeholder="Enter Bundling Name" required
                                                        class="text-sm rounded-lg bg-light-primary-1 w-full dark:bg-dark-primary-1 dark:text-light-primary-1 border !border-gray-500 dark:!border-typography-3"
                                                        type="text" v-model="newBundling.name
                                                            " />
                                                    <input placeholder="Enter Bundling Price" required
                                                        class="text-sm rounded-lg bg-light-primary-1 w-full dark:bg-dark-primary-1 dark:text-light-primary-1 border !border-gray-500 dark:!border-typography-3"
                                                        type="number" v-model="newBundling.price
                                                            " />
                                                    <multiselect v-model="newBundling.items
                                                        " :options="allProduct" :searchable="true"
                                                        :close-on-select="false" label="product_name" :multiple="true"
                                                        track-by="product_name" :preserve-search="true"
                                                        placeholder="Select Product">
                                                        <template #selection="{
                                                            values,
                                                            search,
