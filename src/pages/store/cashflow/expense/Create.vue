...
function addSubCategory(newSubCategory) {
    ...
    data.value.sub_category.push(sub_Category)
    form.value.expense_sub_category = sub_Category
}
                            ...
                            <div class="grid grid-cols-2 gap-3 p-3">
                                ...
                                <div class="flex flex-col gap-2 text-sm">
                                    <label class="dark:text-light-primary-1" for="expense_category">Expense
                                        Category</label>
                                    <multiselect id="expense_category" v-model="form.expense_category"
                                ...
                                <div class="flex flex-col gap-2 text-sm">
                                    <label class="dark:text-light-primary-1" for="expense_sub_category">Expense
                                        Sub Category</label>
                                    <multiselect id="expense_sub_category" v-model="form.expense_sub_category"
                                        ...
                                        label="category_name" track-by="category_name" :preserve-search="true"
                                        placeholder="Select Expense Sub Categories" :taggable="true"
                                        @tag="addSubCategory">
                                    </multiselect>
                                </div>
                                <div class="flex flex-col gap-2 text-sm">
                                ...
                                <div class="flex flex-col gap-2 text-sm col-span-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter Expense Item" @change="handleFileChange" required />
                                </div>
                            </div>
                        </div>
                        <button
