            ...
            <form @submit.prevent="submitLogin" class="w-full">
                ...
                <div class="space-y-4">
                    ...
                    <button
                        ...
                        :disabled="processing"
                        type="submit"
                        class="font-poppins p-2 text-gray-700 hover:bg-[#f8f8f6] bg-[#f4f0ed] rounded-lg w-full text-center text-sm font-semibold font-cabinet uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-1">
                        <p>LOGIN</p>
                        <svg
                            v-if="processing"
                            role="status"
