...
import CashFlow from '@/components/Report/table/TableCashFlow.vue'
        ...
        <div class="w-full space-y-3">
            <div class="grid grid-cols-3 gap-3">
                ...
                <div
                    ...
                    <div class="flex flex-col justify-center items-center w-full">
                        <p class="text-xl font-medium" :class="data.proloss > 0
                            ? 'text-secondary-3'
                            : 'text-red-500'
                            ">
            ...
            <CashFlow :expenses="filteredExpenses" :fetchExpense="fetchExpense" />
        </div>
    </ReportLayout>
</template>
