...
import AddVoucher from '@/components/dialog/add/AddVoucher.vue'
...
const headersUser = [
    { key: 'name', title: 'Voucher Name' },
    { key: 'name', title: 'Validity' },
    { key: 'email', title: 'Discount' },
    { key: 'email', title: 'Code' },
    ...
    <div class="relative">
        ...
        <div class="bg-ezzora-100 p-5 rounded-lg space-y-3 border">
            <div class="flex justify-between items-center">
                <AddVoucher :method="addUser"></AddVoucher>
                <input
                    type="text"
                    v-model="searchUser"
