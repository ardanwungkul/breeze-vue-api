    ...
    datasets: [
        {
            ...
            data: [0, 20, 40, 50, 60, 70, 80, 82, 89, 90, 95, 60],
            fill: true,
        },
        {
            label: 'Expense',
            borderColor: '#FF004D',
            backgroundColor: 'rgba(66, 165, 245, 0.2)',
            data: [46, 10, 19, 24, 30, 40, 30, 60, 43, 88, 90, 100],
            fill: true,
        },
        {
            label: 'Profit',
...
<template>
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            <div class="text-2xl dark:text-typography-1">Revenue and Profit Report</div>
            <div>
                <select name="" id=""
