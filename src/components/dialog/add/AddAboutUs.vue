...
<template>
    <v-dialog>
        ...
        <template v-slot:default="{ isActive }">
            <div
                class="w-full min-h-[calc(100vh-48px)] overflow-y-scroll invisible-scrollbar">
                <div
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    ...
                                    <div class="flex flex-col gap-2 text-sm">
                                        ...
                                        <Editor
                                            ...
                                            api-key="jkhiia9kovq641lwnylmyfhbnd2wio1chdku3lvam2mh8pmk"
                                            :init="{
