...
const handleAdd = async () => {
    ...
    formData.append('date_until', date_until.value)
                        ...
                        <div class="space-y-3">
                            <div class="grid grid-cols-2 gap-3">
                                <div
                                    ...
                                    <label class="text-center" for="title"
                                ...
                                <div class="flex flex-col gap-2 text-sm">
                                    <label class="text-center" for="date_from"
                                        >Start Flash Sale</label
                                    >
                                    <input
                                        class="text-sm rounded-lg bg-gray-100 w-full"
                                        type="datetime-local"
                                ...
                                <div class="flex flex-col gap-2 text-sm">
                                    <label class="text-center" for="date_until"
                                        >End Flash Sale</label
                                    >
                                    <input
                                        class="text-sm rounded-lg bg-gray-100 w-full"
                                        type="datetime-local"
